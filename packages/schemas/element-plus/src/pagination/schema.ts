          ...
          },
          {
            ...
            children: [
                ...
                children: [
                  {
                    ...
                    events: {
                      onClick() {
                        ...
                        // @ts-expect-error
                        this.formData.value.visiblePageSizeVariableBindDialog = true
                      },
                    },
                  },
                ],
              },
              {
                type: 'al-dialog',
                id: 'dialog',
                field: 'visiblePageSizeVariableBindDialog',
                modelField: 'modelValue',
                props: {
                  title: '变量绑定',
                  width: '1000px',
                    ...
                    events: {
                      ...
                      confirmChange: {
                        run() {
                          // eslint-disable-next-line ts/ban-ts-comment
                          // @ts-expect-error
                          this.formData.value.visiblePageSizeVariableBindDialog = false
                        },
                      },
                      cancelChange: {
                        run() {
          ...
          },
          {
            ...
            children: [
                ...
                children: [
                  {
                    ...
                    events: {
                      onClick() {
                        // eslint-disable-next-line ts/ban-ts-comment
                        // @ts-expect-error
                        this.formData.value.visibleDefaultPageSizeVariableBindDialog = true
                      },
                    },
                  },
                ],
              },
              {
                type: 'al-dialog',
                id: 'dialog',
                field: 'visibleDefaultPageSizeVariableBindDialog',
                modelField: 'modelValue',
                props: {
                  title: '变量绑定',
                  width: '1000px',
                    ...
                    events: {
                      ...
                      confirmChange: {
                        run() {
                          // eslint-disable-next-line ts/ban-ts-comment
                          // @ts-expect-error
                          this.formData.value.visibleDefaultPageSizeVariableBindDialog = false
                        },
                      },
                      cancelChange: {
                        run() {
          ...
          },
          {
            ...
            children: [
                ...
                children: [
                  {
                    ...
                    events: {
                      onClick() {
                        // eslint-disable-next-line ts/ban-ts-comment
                        // @ts-expect-error
                        this.formData.value.visibleTotalVariableBindDialog = true
                      },
                    },
                  },
                ],
              },
              {
                type: 'al-dialog',
                id: 'dialog',
                field: 'visibleTotalVariableBindDialog',
                modelField: 'modelValue',
                props: {
                  title: '变量绑定',
                  width: '1000px',
                    ...
                    events: {
                      ...
                      confirmChange: {
                        run() {
                          // eslint-disable-next-line ts/ban-ts-comment
                          // @ts-expect-error
                          this.formData.value.visibleTotalVariableBindDialog = false
                        },
                      },
                      cancelChange: {
                        run() {
          ...
          },
          {
            ...
            children: [
                ...
                children: [
                  {
                    ...
                    events: {
                      onClick() {
                        // eslint-disable-next-line ts/ban-ts-comment
                        // @ts-expect-error
                        this.formData.value.visiblePageCountVariableBindDialog = true
                      },
                    },
                  },
                ],
              },
              {
                type: 'al-dialog',
                id: 'dialog',
                field: 'visiblePageCountVariableBindDialog',
                modelField: 'modelValue',
                props: {
                  title: '变量绑定',
                  width: '1000px',
                    ...
                    events: {
                      ...
                      confirmChange: {
                        run() {
                          // eslint-disable-next-line ts/ban-ts-comment
                          // @ts-expect-error
                          this.formData.value.visiblePageCountVariableBindDialog = false
                        },
                      },
                      cancelChange: {
                        run() {
          ...
          },
          {
            ...
            children: [
                ...
                children: [
                  {
                    ...
                    events: {
                      onClick() {
                        // eslint-disable-next-line ts/ban-ts-comment
                        // @ts-expect-error
                        this.formData.value.visibleCurrentPageVariableBindDialog = true
                      },
                    },
                  },
                ],
              },
              {
                type: 'al-dialog',
                id: 'dialog',
                field: 'visibleCurrentPageVariableBindDialog',
                modelField: 'modelValue',
                props: {
                  title: '变量绑定',
                  width: '1000px',
                    ...
                    events: {
                      ...
                      confirmChange: {
                        run() {
                          // eslint-disable-next-line ts/ban-ts-comment
                          // @ts-expect-error
                          this.formData.value.visibleCurrentPageVariableBindDialog = false
                        },
                      },
                      cancelChange: {
                        run() {
