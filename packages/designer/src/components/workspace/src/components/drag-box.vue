...
<template>
  <div class="w-full box-border relative cursor-move flex mb-1" :class="show ? `outline outline-active-color outline-2` : `outline-dashed outline-active-color outline-1`" v-bind="$attrs" @mouseenter="showOptions = true" @mouseleave="showOptions = false" @click.stop="changeCompId">
